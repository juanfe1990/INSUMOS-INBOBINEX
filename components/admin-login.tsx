      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-[#C8CDC9]/20 bg-[#FDFDFD] p-8 shadow-2xl">
          <div className="mb-6 text-center">
            ...
            <h1 className="font-heading text-xl font-bold text-[#2E4040]">Iniciar Sesion</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label htmlFor="email" className="mb-1.5 block text-sm font-semibold text-[#2E4040]">
                Correo electronico
              </label>
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="mb-1.5 block text-sm font-semibold text-[#2E4040]">
                Contraseña
              </label>
              <div className="relative">
