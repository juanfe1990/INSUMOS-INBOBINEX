        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-[#2E4040]">Telefono</h3>
                <a href="tel:+573001234567" className="mt-1 text-[#949E97] transition-colors hover:text-[#3F8346]">
                  +57 300 123 4567
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-[#2E4040]">Correo</h3>
                <a href="mailto:ventas@inbobinex.com" className="mt-1 text-[#949E97] transition-colors hover:text-[#3F8346]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-[#2E4040]">Ubicacion</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-[#2E4040]">Horario</h3>
                <p className="mt-1 text-[#949E97]">Lunes a Viernes: 8:00 AM - 6:00 PM</p>
          ...
          <div className="flex flex-col items-center justify-center rounded-xl border border-[#C8CDC9] bg-[#C8CDC9]/10 p-8 text-center">
            ...
            <a
              href="https://wa.me/573001234567?text=Hola, me interesa cotizar productos de embalaje"
              target="_blank"
